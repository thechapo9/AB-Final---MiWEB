    ...
    <div class="container-fluid" style="background-color: beige; padding: 0.5vh 0.5vw;">
        <div class="container text-center">
            <div class="row">
                ...
                <div class="col">
                    <a class="btn btn-secondary" href="../index.php">Nuevos productos <span><i class="fa-solid fa-magnifying-glass"></i></span></a>
                </div>
                <div class="col">
...
<body>
    <div class="login">
        <form action="../PHP/inicio_sesion.php" method="post">
            ...
            <br>
            <div style="display: flex;justify-content:center; align-items: center;">
                <a class="btn btn-link" href="registro.php">¿No tienes cuenta? Registrate aquí</a>
            </div>
...
<footer id="footer">
    <div class="texto--footer">
        ...
        <a class="buttoms--envios" href="Pages/login.php">Ver pedidos</a>
        <a href="tienda.php">
