...
<body style="background-color: beige;">
    ...
    if (isset($_SESSION["Nombre_Usuario"]) && isset($_SESSION['idUsuarios'])) {
        ...
        FROM 
            pedidos 
        INNER JOIN 
            usuarios ON pedidos.id_Usuarios = usuarios.idUsuarios
        WHERE 
            ...
            <div class="col-12 col-md-12 mx-auto">
                <?php if (!empty($pedidos)) { ?>
                    <table class="table table-light table-bordered">
                        <tbody>
                            <tr>
                                <th width="16%" class="text-center">Nombre de usuario</th>
                                <th width="20%" class="text-center">Direccion</th>
                                <th width="16%" class="text-center">Telefono</th>
                                <th width="16%" class="text-center">Fecha de pedido</th>
                            ...
                            <?php foreach ($pedidos as $pedido) { ?>
                                ...
                                <tr>
                                    <td width="16%" class="text-center"><?php echo $_SESSION["Nombre_Usuario"] ?></td>
                                    <td width="20%" class="text-center"><?php echo $pedido["Direccion"] ?></td>
                                    <td width="16%" class="text-center"><?php echo $pedido["Telefono"] ?></td>
                                    <td width="16%" class="text-center"><?php echo $pedido["Fecha_de_pedido"] ?></td>
                                    <td width="16%" class="text-center"><?php echo $pedido["Total"] ?>€</td>
                                    <td width="16%" class="text-center"><?php echo $pedido["status"] ?></td>
                                </tr>
                            <?php } ?>
                        <?php } else { ?>
